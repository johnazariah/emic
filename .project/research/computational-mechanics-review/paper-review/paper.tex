...
Numerical validation using the \texttt{emic} library confirms that inference algorithms recover correct \eM s with sufficient data, with complexity measures converging to theoretical values. Among the algorithms tested, Spectral learning achieves 100\% accuracy at $N \geq 10{,}000$, while CSSR achieves 82\% overall correctness with a known blind spot on the Even Process.
