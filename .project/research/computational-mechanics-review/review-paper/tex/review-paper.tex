...
\noindent For practical guidance on applying these algorithms to real data, including worked Python examples and algorithm deep dives, see the \texttt{emic} documentation at \url{https://johnazariah.github.io/emic/}.
